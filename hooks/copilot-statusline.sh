#!/bin/bash
# caveman — statusline badge script for Copilot CLI
# Reads the caveman mode flag file and outputs a colored badge.
#
# Usage in ~/.copilot/settings.json:
#   "statusLine": { "type": "command", "command": "bash /path/to/copilot-statusline.sh" }
#
# Requires Copilot CLI v1.0.11+. Flag file: ~/.copilot/.caveman-active

FLAG="${HOME}/.copilot/.caveman-active"
